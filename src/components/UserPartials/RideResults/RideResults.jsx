                  ...
                  <div key={_.get(ride, 'id', null)} className="col-xl-12 col__transition">
                    <div className="card card__ride shadow-sm animate__animated animate__fadeInDown">
                      <div className="card-body d-flex ride">
                        <div className="ride__body d-flex">

                          <div className="ride__content">
                            <div className="d-flex align-items-center">
                              <IoBusiness className="mr-2" size={24} />
                              <h5 className="m-0 fs-20">{_.get(ride, 'park.park_name', null)}</h5>
                            </div>

                            <div className="d-flex align-items-center mt-2">
                              <MdDirectionsBus className="mr-2" size={22} />
                          ...
                          <div className="ride__extra d-flex justify-content-between">
                            <div className="mr-sm-2">
                              ...
                              <p className="m-0 mt-2 font-w800 fs-16 badge badge-pill badge-danger light">{_.get(ride, 'starting_point', null)}</p>
                            </div>
                            ...
                            <div>
                              ...
                              <p className="m-0 mt-2 font-w800 fs-16 badge badge-pill badge-danger light">{_.get(ride, 'destination', null)}</p>
                            </div>
                          </div>
                        ...
                        <div className="ride__actions">
                          <div className="badge badge-pill bg-dark-yellow fs-18 font-w600">{moneyFormat.to(_.get(ride, 'price', null))}</div>
                          <button 
                            onClick={() => displayRides(index)}
                            disabled={(_.size(_.get(ride, 'buses', [])) > 0) ? false : true}
                            className="btn btn-sm btn-danger"
                          >
                            <MdKeyboardArrowDown className="mr-2" size={20} />
                            View Rides
                          </button>
                        </div>
                      </div>
                        ...
                        <div className="row list__row text-left list">
                          {(_.get(ride, 'buses', [])).map((rideBus) => (
                            <div key={_.get(rideBus, 'id', null)} className="col-xl-12 mb-2 animate__animated animate__slideInDown">
                              <div className="d-flex align-items-center justify-content-center flex-column flex-md-row list__item py-2 rounded">
                                <div className="d-flex flex-column flex-md-row  mr-4">
                                  <div className="d-flex flex-column flex-md-row">
                                    <IoBus className="mr-2 text-danger" size={20} />
                                    <div className="text-center">{_.get(rideBus, 'ride_name', null)}</div>
                                  </div>
                                  <div className="ml-2 badge badge-light">{formatTime(_.get(rideBus, 'departure_time', null))}</div>
                                </div>
                                <button
