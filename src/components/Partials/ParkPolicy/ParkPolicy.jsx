...
const ParkPolicy = () => {
  ...
  return (
    <Fragment>
      ...
      >
        <h4 className="text-gray font-w600 mt-3 mb-3">TERMINAL ADMIN AGREEMENT</h4>
        ...
        <p className="text-gray my-2">
          ✔  I have read, and hereby acknowledge and accept the Terminal Admin Agreement and Privacy Policy.
        </p>

        <p className="text-gray my-2">
          This Agreement herein after referred to as “Agreement” contains the complete terms and conditions between Mile9ine hereinafter referred to as “Mile9ine” and the bus/car terminal admin hereinafter referred to as the “Terminal Admin” with regards to his/her application to participate as a Terminal Admin under this Mile9ine Bus/Car Terminal Program.
        </p>
        ...
        ·   “Bus/Car Terminal Program” is a program that accepts applicants who work for designated bus/car transport terminals as terminal admin.<br />
        
        ·   “The Bus/Car Terminal” shall mean a bus/car transport company authorised to appoint a terminal admin to access and use the Mile9ine website solely for the purpose of booking passenger tickets for the bus/car transport company, as an independent contractor and in accordance with the terms of this agreement. Furthermore, it i s not in liquidation, insolvent, bankrupt or otherwise subject in a position to become subject to bankruptcy proceedings.<br />
        ...
        ·   “Independent contractors” are bus/car transport terminals who contracts to make use of the Mile9ine website according to his/her own methods and processes.<br />
        ...
        <p className="text-gray my-2">
          ...
          The terminal admin wants permission and approval to access, promote and utilize the Mile9ine website via their bus/car terminal where s/he have requisite legal tenancy or ownership. S/he is also desirous of utilizing the website for a fee and understands that this agreement is legally binding and carries legal obligations.<br />
          
          The terminal admin will acquire all the staffing resources and equipment necessary and appropriate to carry on his/her business using the website.
          
          Mile9ine and the terminal admin are separate independent and autonomous entities. The terminal admin acknowledges that s/he is an independent contractor.<br />
          
          The applicant recognises that to become a terminal admin with Mile9ine, s/he must submit a completed application form via the official website, which will be evaluated and the applicant notified of his/her acceptance and that Mile9ine is entitled to reject the application at its sole discretion. The applicant understands s/he shall have no right to appeal any decision to reject his/her application.<br />
          
          The terminal admin is aware that Mile9ine’s delegated authority is required to act as an agent on its behalf.<br />
          
          The terminal admin accepts that Mile9ine may suspend this agreement at its sole discretion and without any compensation.<br />
          
          The terminal admin understands that the product offering under this agreement is online ticket management and any other product introduced by Mile9ine from time to time.<br />
        </p>
        ...
        <ul>
          <li className="mb-3">
            ...
            <div className="ml-4">
              <p className="text-gray my-2">
                ·   That the terminal admin cannot carry out activities provided by the object of this agreement on behalf of companies/entities in competition with Mile9ine.<br />

                ·   That the terminal admin does not own any holding, directly or indirectly, in any entity in competition with Mile9ine. In the event that this is discovered, Mile9ine reserves the right to pursue damages.<br />
              </p>
            </div>
          </li>

          <li className="mb-3">
            <h4 className="text-gray font-w600">2.  OBLIGATIONS OF THE TERMINAL ADMIN</h4>
            <div className="ml-4">
              <p className="text-gray my-2">
              ...
              ·   The Terminal Admin is solely responsible for the technical operation of his/her facilities and his/her designated bus/car terminal and staff.<br />
              
              ·   The Terminal Admin has complied with all obligations to their employees, arising from laws and regulations concerning Nigeria Labour Laws.<br />
              </p>
            </div>
          </li>
          ...
          <li className="mb-3">
            ...
            <div className="ml-4">
              <p className="text-gray my-2">
              ·   To provide an admin account for the terminal admin to carry out online ticketing operations.<br />
          ...
          <li className="mb-3">
            ...
            <div className="ml-4">
              <p className="text-gray my-2">
              ·   By entering this agreement, the terminal admin is accepting that Mile9ine shall grant him/her a non-transferable, non-exclusive, revocable license to use the website to facilitate his/her bus/car transportation business.<br />

              ·   The terminal admin is not permitted to alter, modify or change the licensed materials in anyway whatsoever.<br />

              ·   The terminal admin is not permitted to use the licensed materials in any manner that is disparaging or otherwise portrays Mile9ine or anyone else negatively.<br />

              ·   The terminal admin acknowledges that s/he has not acquired and will not acquire any right, interest or title to the Mile9ine brand by reason of his/her activities hereunder.<br />
          ...
          <li className="mb-3">
            ...
            <div className="ml-4">
              <p className="text-gray my-2">
              ·   The terms of this agreement will begin upon acceptance as a terminal admin and will end when terminated by either party.<br />

              ·   At any time, Mile9ine or the terminal admin may terminate this agreement with or without cause, by giving the other party 30 days written notice of termination, and such notice may be served via email or written letter.<br />
              </p>
            </div>
          </li>
          ...
          <li className="mb-3">
            ...
            <div className="ml-4">
              <p className="text-gray my-2">
                ...
                ·   The terminal admin agrees that posting of modification/update of this agreement on the Mile9ine website and/or by mail is considered sufficient provision of notice and as such, modifications shall be effective as of date of posting so long as the website services are still in use. Modifications may include, but are not limited to, changes in terms and payment schedule.<br />
                
                ·   If any modification is unacceptable to the terminal admin, his/her sole recourse is to terminate this agreement and his or her continued participation following posting of modification of agreement on the Mile9ine website.<br />
                
                ·   The terminal admin has agreed to frequently visit the mile9ine website to review the terms and conditions of this agreement.<br />
              </p>
            </div>
          </li>
          ...
          <li className="mb-3">
            ...
            <div className="ml-4">
              <p className="text-gray my-2">
                ·   Mile9ine will not be liable for any indirect, special or consequential damages, or any loss of revenue, profits or data rising in connection with this agreement in the course of facilities used in the bus/car terminal of the terminal agent.<br />
              </p>
            </div>
          </li>
          ...
          <li className="mb-3">
            ...
            <div className="ml-4">
              <p className="text-gray my-2">
                ·   The terminal admin and Mile9ine are independent contractors, and nothing in this agreement will create any partnership, joint venture, agency, franchise, sales representative, or employment relationship between the parties.<br />
              </p>
            </div>
          </li>
          ...
          <li className="mb-3">
            ...
            <h6 className="my-2">The terminal admin hereby represent and warrant to Mile9ine the following;</h6>
            <div className="ml-4">
              <p className="text-gray my-2">
          ...
          <li className="mb-3">
            ...
            <div className="ml-4">
              <p className="text-gray my-2">
                ·   Mile9ine may disclose to the agent certain confidential information as a result of his/her participation as a terminal admin (herein referred to as “Confidential Information”). Confidential information shall remain strictly confidential and secret and shall not be utilized, directly or indirectly, by the terminal admin for his/her own business purposes or for any other purpose except and solely to the extent that any such information is generally known or available to the public or if the same is required by law or legal process.<br />
              </p>
            </div>
          </li>
          ...
          <li className="mb-3">
            ...
            <div className="ml-4">
              <p className="text-gray my-2">
                ...
                ·   The terminal admin acknowledges that he has read this agreement, evaluated interest in being a party to execute this agreement, has had an opportunity to consult with his own legal advisor and agree to all its terms and conditions.<br />
                
                ·   This Agreement and any matters relating hereto shall be governed by and construed in accordance with Nigerian laws.<br />
                
                ·   The terminal admin cannot assign this agreement, by operation of law or otherwise, without prior written consent of Mile9ine. Subject to that restriction, this agreement will be binding on and enforceable against the parties and their respective successors and assigns.<br />
