...
import { withAgentDetails, withUserAgent } from '../../../recoil/ParkAgent';
import WalletUpdater from '../WalletUpdater/WalletUpdater';
import './AgentMiniHeader.css';

const AgentMiniHeader = () => {
          ...
          <nav className="navbar navbar-expand">
            <div className="collapse navbar-collapse justify-content-between">
              ...
              <ul className="navbar-nav header-right">
                <WalletUpdater 
                  balance={_.get(agentDetails, 'agent_wallet_amount', '0.00')}
                ...
                <li className="nav-item dropdown header-profile">
                  ...
                  <div className="dropdown-menu dropdown-menu-right">
                    <Link to={`/park/staff/profile-${slugify(agentProfile?.name)}`} className="dropdown-item ai-icon">
